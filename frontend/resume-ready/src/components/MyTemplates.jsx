	...
	return (
		<>
			...
			<div className="relative">
				...
				<div className="my-template-title-container flex justify-center">
			...
			<DisplayTemplates rowCount={rowItemCount} items={myTemplates}/>
			<div className="p-4"/>
			<GeneralFooter/>
		</>
	)
	...
	if (items.length == 0) {
		...
		itemRowContainers.push(
			<div className="text-center text-xl p-20">
				You have no templates... Purchase some?
			</div>
		)
	}
